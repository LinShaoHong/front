...
const tempMsgs = ref(['亲爱的，我知道最近我们之间有些误会和疏远，我真的很后悔没有处理好我们之间的问题。你的快乐和笑容对我来说无比重要，我愿意付出所有努力去理解和改正。请给我一次机会，让我们一起找回那份曾经的美好和温暖，好吗？我爱你，从未改变。这段话充满了诚挚的歉意和渴望挽回的心声，希望能够触动对方的心，重新点燃彼此之间的爱火。']);
...
<template>
  ...
  <view class="relative w-screen h-screen">
    ...
    <view v-if="!write"
      ...
      <view class="w-full h-full flex justify-around pb-5 mb-15"
  ...
  <Popup :show="showTemplate" position="bottom" @clickMask="showTemplate=false">
      ...
      <view class="w-full h-80vh"
        ...
        <scroll-view scroll-y :show-scrollbar="false">
          <view class="w-100vw" style="height: calc(80vh - 45px)">
            ...
            <view v-for="msg in tempMsgs" class="w-full flex items-center justify-center mb-30"
