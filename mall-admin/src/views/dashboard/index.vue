...
export default {
  ...
  created() {
    info().then(response => {
      this.userTotal = response.value.userTotal
      this.goodsTotal = response.value.goodsTotal
      this.productTotal = response.value.productTotal
      this.orderTotal = response.value.orderTotal
    })
  },
  methods: {
