<template>
  ...
  >
    ...
    <footer>
      <div class="footer">
        <p style="color: whitesmoke; font-size: 18px;">寻芳阁</p>
        <p style="color: whitesmoke; font-size: 13px;">Copyright@ 2020-2021 Xunfg All Rights Reserved. <a style="color: #f90;">版权声明</a></p>
