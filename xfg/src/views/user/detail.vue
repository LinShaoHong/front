<template>
  <div :class="mobile ? 'app-container mobile' : 'app-container'">
    <div v-if="user != null" class="detail-container" >
      <el-divider><span style="color: #f90; font-size: 20px;">个人中心</span></el-divider>
      <el-collapse v-model="activeName" accordion>
        <el-collapse-item title="个人信息" name="1">
          <div class="user-info">
            <div class="info-label">上传头像:</div>
            ...
            <div class="info-label">连续签到次数:</div>
            <div v-if="user.signInCount === 0" class="info-value" style="float: left">
              您还未签到过哦 点击
              <a style="cursor: pointer; color: #f90;" @click="signIn">签到</a>
            </div>
            ...
            <div v-else class="info-value">
              {{ user.signInCount }}次 今日已签到
            </div>
            <div class="info-label">最近签到时间:</div>
        ...
        <el-collapse-item :title="'最近浏览'" name="3">
        ...
        <el-collapse-item title="金币收支" name="4">
          <div style="margin-left: 37px;">
            ...
            >
              ...
              <el-radio label="PAYMENT" style="color: whitesmoke">消费</el-radio>
              <el-radio label="RECHARGE" style="color: whitesmoke">充值</el-radio>
              <el-radio label="SING_IN" style="color: whitesmoke">签到</el-radio>
            </el-radio-group>
          </div>
            ...
            <el-timeline>
              <el-timeline-item
                ...
                <div v-if="flow.type === 'SING_IN'">
                  <span style="color: #a3a2a2">签到</span>&nbsp;&nbsp;<span style="color: whitesmoke">+{{ flow.amount }}</span>
                </div>
                ...
                <div v-else>
                  <span style="color: #a3a2a2">请教付费</span>&nbsp;&nbsp;<span style="color: whitesmoke">-{{ flow.amount }}</span>
              ...
              <el-timeline-item v-if="!flowsEnd">
                <span style="color: whitesmoke; font-size: 10px; cursor: pointer" @click="getFlows">显示更多.....</span>
              </el-timeline-item>
            </el-timeline>
          </div>
          <div v-else class="empty">
    ...
    <div v-else class="noLogin">
      <span>您还未<a style="cursor: pointer; color: #f90;" @click="toLogin">登录</a>....</span>
    </div>
  </div>
</template>
...
export default class extends mixins(Layout) {
  ...
  get uploadAvatarPath() {
    if (this.user !== null) {
      return uploadAvatarPath+"?XFG-TOKEN=" + Cookies.get('XFG-TOKEN')
    }
  ...
  private async signIn() {
    ...
    if (data.code == 200) {
      ...
      if (this.flowsType === '' || this.flowsType === 'SING_IN') {
        this.flows.unshift({ amount: 1, type: "SING_IN", chargeType: null, time: '刚刚', girl: null})
      }
    }
  }
