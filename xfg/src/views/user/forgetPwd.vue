<template>
  <div :class="mobile ? 'app-container mobile' : 'app-container'">
    <div class="forgetPwd-container" >
      <el-divider><span style="color: #f90; font-size: 20px;">密码找回</span></el-divider>
      <el-form :model="forgetForm"
        ...
        <el-form-item label-width="0" label="" prop="email" class="label-item">
          <el-input placeholder="邮箱地址" v-model.number="forgetForm.email"></el-input>
        </el-form-item>
        <el-form-item v-if="second > 0" style="height: 5px; margin-bottom: 50px;">
          <span  style="float: right; color: #f90; " href="#">{{ '登录邮箱更改密码  (' + second + ')' }}</span>
        </el-form-item>
        <el-form-item label-width="0">
          <el-button type="primary" style="width: 100%;" @click="send">发送</el-button>
        </el-form-item>
        <el-form-item label-width="0">
          <a style="float: right; color: #f90; cursor: pointer" @click="toLogin">已找回账号，直接登录</a>
        </el-form-item>
      </el-form>
    </div>
  </div>
