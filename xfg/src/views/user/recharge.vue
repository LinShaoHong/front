  ...
  <div :class="mobile ? 'app-container mobile' : 'app-container'">
    <div v-if="user != null" class="recharge-container" >
      ...
      <div class="recharge-form">
        <div class="charge-info-label">用户名:</div>
        <div class="charge-info-value">{{ user.name }}</div>
        <div class="charge-info-label">购买产品:</div>
        <div class="product-select charge-info-value" style="margin-left: 15px;">
          <el-select v-model="type"
                     size="medium">
            <el-option label="10 金币" value="TEN">
              10金币
            </el-option>
            <el-option label="30 金币" value="THIRTY">
              30金币
            </el-option>
            <el-option label="50 金币" value="FIFTY">
              50金币
            </el-option>
          ...
          <span style="color: #f90; font-size: 18px;">会员可免费获取本站所有资源！！</span>
        </div>
        <div class="charge-info-label">充值金额:</div>
        <div class="charge-info-value">{{ amount }}</div>
        <div class="charge-info-label">输入卡号:</div>
        <div class="charge-info-value">
          <input
            class="card-input"
            v-model="cardNo"
            style=""></input>
          <a style="color: #f90; font-size: 15px; margin-left: 13px; cursor: pointer">-->点击购买官方卡号</a>
        </div>
      </div>
