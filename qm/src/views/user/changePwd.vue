<template>
  <div :class="mobile ? 'app-container mobile' : 'app-container'">
    <div v-show="valid" class="changePwd-container" >
      <el-divider><span style="color: #f90; font-size: 20px;">更改密碼</span></el-divider>
      <el-form :model="changeForm"
        ...
        <el-form-item label-width="0" label="" prop="password" class="label-item">
          <el-input placeholder="新密碼" type="password" v-model="changeForm.password" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="0" label="" prop="checkPass" class="label-item">
          <el-input placeholder="確認新密碼" type="password" v-model="changeForm.checkPass" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="0">
          <el-button type="primary" style="width: 100%;" @click="change">更改</el-button>
        </el-form-item>
        <el-form-item label-width="0">
          <a style="float: right; color: #f90; cursor: pointer" @click="toLogin">找回賬號，直接登錄</a>
        </el-form-item>
      </el-form>
    </div>
